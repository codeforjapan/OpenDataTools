...
exports.SchemeFormatterItemLabel = void 0;
class SchemeFormatterItemLabel {
  labelList = {
    codeOfPrefectureSection: {
      collectValue: '都道府県コード又は市区町村コード',
      whiteList: ['都道府県コード', '市区町村コード', '都道府県コ-ド又は市区町村コ-ド'],
    },
    ...
    poiCode: { collectValue: 'POIコード', whiteList: ['POI', 'POIコ-ド'] },
...
exports.SchemeFormatterItemLabel = SchemeFormatterItemLabel;
