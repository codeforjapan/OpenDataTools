...
export class Moji {
  ...
  private Z_KANA = ['ヴ', 'ガ', 'ギ', 'グ', 'ゲ', 'ゴ', 'ザ', 'ジ', 'ズ', 'ゼ', 'ゾ', 'ダ', 'ヂ', 'ヅ', 'デ', 'ド', 'バ', 'ビ', 'ブ', 'ベ', 'ボ', 'パ', 'ピ', 'プ', 'ペ', 'ポ', 'ア', 'イ', 'ウ', 'エ', 'オ', 'カ', 'キ', 'ク', 'ケ', 'コ', 'サ', 'シ', 'ス', 'セ', 'ソ', 'タ', 'チ', 'ツ', 'テ', 'ト', 'ナ', 'ニ', 'ヌ', 'ネ', 'ノ', 'ハ', 'ヒ', 'フ', 'ヘ', 'ホ', 'マ', 'ミ', 'ム', 'メ', 'モ', 'ヤ', 'ユ', 'ヨ', 'ラ', 'リ', 'ル', 'レ', 'ロ', 'ワ', 'ヲ', 'ン', 'ァ', 'ィ', 'ゥ', 'ェ', 'ォ', 'ャ', 'ュ', 'ョ', 'ッ', '、', '。', '「', '」', 'ー'];
  ...
  public convert(category: MojiCategory, direction: MojiDirection): string {
    if (category === 'alphanumeric') {
      const addition = direction === 'ZtoH' ? -65248 : 65248;
      const regex = direction === 'ZtoH' ? /[Ａ-Ｚａ-ｚ０-９]/g : /[A-Za-z0-9]/g;
      return this.targetString.replace(regex, (char: string) => String.fromCharCode(char.charCodeAt(0) + addition));
    }
    ...
    return this.targetString.replace(regex, (char: string) => {
